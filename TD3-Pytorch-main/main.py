...
parser.add_argument('--EnvIdex', type=int, default=0, help='ANE ,PV0, Lch_Cv2, Humanv2, HCv2, BWv3, BWHv3')
...
def main():
    EnvName = ['AntBulletEnv-v0','Pendulum-v1','LunarLanderContinuous-v2','Walker2DBulletEnv-v0','HalfCheetahBulletEnv-v0','BipedalWalker-v3','BipedalWalkerHardcore-v3']
    BrifEnvName = ['ANE','PV0', 'LLdV2', 'Humanv2', 'HCv2','BWv3', 'BWHv3'] #Brief Environment Name.
    ...
    if opt.render:
        work_dir = mkdir('exp',BrifEnvName[EnvIdex])
        monitor_dir = mkdir(work_dir,'monitor')
        print(monitor_dir)
        score = evaluate_policy(env, model, opt.render, turns=20 ,video_dir= monitor_dir)
